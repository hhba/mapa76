...
WORKERS=2
PORT=50005
CMD="/usr/local/bin/analyzer -f /home/deploy/apps/mapa76.info/hephaestus/current/config/freeling/config/es.cfg --server --port $PORT --workers $WORKERS --queue $QUEUE  --outf tagged --nec --noflush"
